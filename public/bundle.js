...
class MultiFactorResolverImpl {
    ...
    static _fromError(authExtern, error) {
        ...
        _assert$4(error.serverResponse.mfaPendingCredential, auth, "internal-error" /* INTERNAL_ERROR */);
...
function getMultiFactorResolver(auth, error) {
    ...
    _assert$4(error.operationType, authModular, "argument-error" /* ARGUMENT_ERROR */);
    _assert$4((_a = errorInternal.serverResponse) === null || _a === void 0 ? void 0 : _a.mfaPendingCredential, authModular, "argument-error" /* ARGUMENT_ERROR */);
